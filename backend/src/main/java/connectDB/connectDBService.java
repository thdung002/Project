...
public class connectDBService {
  ...
  public interface Iface {
    ...
    public java.util.List<sale> getSale() throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public java.util.List<sale> getSalebyID(int id) throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public users getUsers(java.lang.String usr, java.lang.String pwd) throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public java.util.List<booking> getBooking() throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public java.util.List<plane> getPlane() throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public int insertBooking(booking infor) throws org.apache.thrift.TException, SQLException, ClassNotFoundException;

    public int insertSale(sale saleinfo) throws org.apache.thrift.TException, SQLException, ClassNotFoundException;
